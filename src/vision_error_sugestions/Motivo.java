...
public class Motivo extends javax.swing.JDialog {
    ...
    public Motivo(java.awt.Frame parent, boolean modal, String texto, int mat) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Descreva o erro encontrado");
        ...
        jLabel10.setText("Relato de Erros");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
       ...
       System.out.println(numero);
        ...
        ErroModel e = new ErroModel();
        e.setMat(mat);
        e.setErro(txtAreaMotivo.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Motivo dialog = new Motivo(new javax.swing.JFrame(), true, texto1, mat);
