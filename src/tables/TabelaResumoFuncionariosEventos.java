...
public class TabelaResumoFuncionariosEventos extends AbstractTableModel {
    ...
    public TabelaResumoFuncionariosEventos (List<TabelaResumoAlteracaoModel> pList){
        mList=pList;
        
    }

    public TabelaResumoFuncionariosEventos() {
