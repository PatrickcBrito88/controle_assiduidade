...
public class TabelaResumoAvaliadores extends AbstractTableModel {
    ...
    public TabelaResumoAvaliadores (List<TabelaResumoAlteracaoModel> pList){
        mList=pList;
        
    }

    public TabelaResumoAvaliadores() {
    ...
    public Object getValueAt(int linha, int coluna) {
        switch (coluna){
            ...
            case 2:
                if (mList.get(linha).isTrava()==true){
                    return "Não editável";
                } else {
                    return "Editável";
                }
            ...
            case 4: 
                return mList.get(linha).getAprovacao();
        }   
         return 0;
    }
