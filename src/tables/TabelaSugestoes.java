...
public class TabelaSugestoes extends AbstractTableModel {
    ...
    private final List<SugestaoModelTabela> mList;
    
    public TabelaSugestoes (List<SugestaoModelTabela> pList){
        mList=pList;
        
    }

    public TabelaSugestoes() {
