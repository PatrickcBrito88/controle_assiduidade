...
public class TabelaAlteracoesAnalise extends AbstractTableModel {
    ...
    public TabelaAlteracoesAnalise (List<TabelaAnaliseModel> pList){
        mList=pList;
        
    }

    public TabelaAlteracoesAnalise() {
    ...
    public Object getValueAt(int linha, int coluna) {
        switch (coluna){
            ...
            case 1:
                return String.valueOf(mList.get(linha).getMat());
            case 2:
